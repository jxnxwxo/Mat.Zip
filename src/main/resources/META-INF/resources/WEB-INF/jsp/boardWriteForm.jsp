...
<head>
	...
	<title>미쉐린 가이드:서울 x 맛.ZIP - 글 쓰기</title>
		    ...
		    <table class="table table-border">
			    ...
			    <tr>
			 	...
			 	<tr>
					...
					<td colspan=2><textarea name="contents" rows="10" cols="53" maxlength="4000"></textarea> </td>
		     	</tr>
		     	<tr>
					<td >파일 첨부 :  </td>
					<td>
					...
					<button type="submit" class="btn" id="writeBtn" >글 쓰기</button>
